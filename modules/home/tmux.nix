...
in
{
  ...
  xdg.configFile = {
    "tmux/palettes/everforest-dark-medium.tmux".source =
      ./files/tmux/palettes/everforest-dark-medium.tmux;
    "tmux/themes/minimal.tmux".source = ./files/tmux/themes/minimal.tmux;
  };
}
